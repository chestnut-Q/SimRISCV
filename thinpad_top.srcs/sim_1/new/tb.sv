...
module tb;
  ...
  parameter BASE_RAM_INIT_FILE = "C:\\code\\project\\cod22-grp12\\testcases\\src.bin"; // BaseRAM 初始化文件，请修改为实际的绝对路径
  parameter EXT_RAM_INIT_FILE = "C:\\code\\project\\cod22-grp12\\testcases\\src.bin";  // ExtRAM 初始化文件，请修改为实际的绝对路径
